...
figure;
subplot(2,1,1)
plot(Data.Date,Data.Ret)
title('S&P500 - Daily Returns ')
ylabel('%')
subplot(2,1,2)
plot(Data.Date,Data.sq_Ret);
title('S&P500 - Daily squared Returns ')
ylabel('%')
...
subplot(2,1,1)
autocorr(Data.Ret)
title('ACF-S&P500-Returns ')
ylabel('p')
subplot(2,1,2)
autocorr(Data.sq_Ret)
title('ACF-S&P500-squared Returns ')
ylabel('p')
...
figure;
plot(Data.Date,Data.Ret); hold on;
plot(Data.Date,cond_Vol); hold off;
title('S&P500 - Daily Returns ')
ylabel('%')
legend('Demean Ret.','Est.Volatility')
...
title('ACF-Std-Returns ')
ylabel('p')
subplot(2,1,2)
autocorr(Data.std_sq_res)
title('ACF-Std-Sq Returns ')
ylabel('p')
